...
int main() {
  ...
  unsigned int i=0;
  unsigned short vsine,vtri;
  unsigned short psine, ptri; //short to send for sine and triangle waves
  unsigned char csine, ctri; //Select channel: 0=A, 1=B
  char m[100];
  while (1) {
      for(i=0;i<100;i++){
...
void delay(){
    ...
    while (_CP0_GET_COUNT() < 48000000 *0.01) {
        ;
    } // delay 0.5s
}
